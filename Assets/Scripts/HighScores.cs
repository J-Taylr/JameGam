...
{
    const string privateCode = "78wf1opm_0yzIQNzra9GbwNgVif9bvGUyRRBf_1EfMTQ";  //Key to Upload New Info
    const string publicCode = "612a7d438f40bb6e98b99018";   //Key to download
